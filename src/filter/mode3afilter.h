...
{
public:
    Mode3AFilter(nlohmann::json& config, FilterManager* parent, IDBVariableResolver& var_resolver);
    ...
    // stateless renderer (reused by callers with an explicit value set)
