...
/**
*/
class PositionRadarRange : public PositionBaseProb
{
public:
    PositionRadarRange(
    ...
    std::string probabilityNameShort() const override final { return "PosRngMean"; }
    std::string probabilityName() const override final { return "Position Range Mean"; }
};
