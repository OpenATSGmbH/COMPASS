...
/**
*/
class SinglePositionRadarAzimuth : public SinglePositionValueBase
{
public:
...
protected:
    ...
    virtual std::string targetTableCustomSortColumn() const override { return "#CF"; }
...
/**
*/
class JoinedPositionRadarAzimuth : public JoinedPositionValueBase
{
public:
