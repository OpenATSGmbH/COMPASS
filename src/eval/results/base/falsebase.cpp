...
/**
 */
void SingleFalseBase::addReportTableColumns(ReportTableDefinition& def) const
{
...
/**
 */
void SingleFalseBase::fillReportTableRow(ReportTableRows& rows,
                                  const EvaluationDetail& detail,
...
/**
 */
void SingleFalseBase::fillDetailFromReportTableRow(EvaluationDetail& detail,
                                  const Buffer& buffer,
                                  unsigned int row,
                                  const EvaluationDetail* prev_detail) const
{
