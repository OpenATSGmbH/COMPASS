...
The same parameters can also be passed to the runtime command interface, using the '-{}-config' option of the 'import\_asterix\_file', 'import\_asterix\_files', 'import\_asterix\_pcap\_file' and 'import\_asterix\_pcap\_files' commands, e.g. \\
'import\_asterix\_file /data/file.ff -{}-config=`\{"filter\_position\_rec\_active": true, "filter\_rec\_latitude\_min": 49.686\}`'.
