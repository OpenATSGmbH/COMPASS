...
Allowed options:
  ...
  --export_report_mode arg              export mode, i.e. 'JSON','Latex','PDF'
...
Sets the report export type to the given value (i.e. 'JSON','Latex','PDF') when exporting a report as described in the section \nameref{sec:report_export}.
