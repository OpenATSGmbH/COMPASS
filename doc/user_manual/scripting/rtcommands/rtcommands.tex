...
config \dots evaluation configuration as json string \\
...
\textcolor{red}{\textbf{[TODO: confirm the analyze\_data\_source JSON payload shape against the most recent Portal schema in compass\_web/doc/analyses.md before release]}}
