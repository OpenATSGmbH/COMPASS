...
\begin{figure}[H]
    \centering
    \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/table_start.png}
...
On the right side resides the Configuration Panel, which contains the variable selection, view-specific options and the Layers Tree.
...
\begin{figure}[H]
    \centering
    \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/table_loaded.png}
...
\begin{figure}[H]
  \centering
    \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/table_single.png}
...
\begin{figure}[H]
  \centering
    \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/table_sort.png}
  \caption{Table View: Mode 3/A sorted}
\end{figure}

By default, the table is sorted by Timestamp descending. \\
...
\begin{figure}[H]
  \centering
    \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/table_mlat_contrib.png}
