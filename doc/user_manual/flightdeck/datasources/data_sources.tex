...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm,frame]{figures/ui_data_sources.png}
...
At the bottom, the 'Timestamps' 'Min' and 'Max' values show the time span of all data stored in the database. They cover all Data Sources and all lines, and are updated during data import. They can be used to check the dates resulting from the ASTERIX timestamp calculation (see \nameref{sec:ui_import_asterix_timestamps}). \\

Also at the bottom, the 'Associations' label indicates if association information exists, and from which Data Source it was generated.\newline
...
\begin{figure}[H]
  \centering
  \hspace*{-1.5cm}
    \includegraphics[width=18cm]{figures/fd_delete_data.png}
  \caption{Data Sources tool: Delete Data}
\end{figure}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=8cm]{figures/fd_delete_data_cfrm.png}
