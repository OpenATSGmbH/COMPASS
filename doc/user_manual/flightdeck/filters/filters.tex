...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Time of Day filter Step row with the eight buttons -60m / -45m / -30m / -15m / +15m / +30m / +45m / +60m]}}\vspace{1.5cm}}}
  \caption{Time of Day filter: Step buttons}
\end{figure}
...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Timestamp filter Step row with the eight buttons -60m / -45m / -30m / -15m / +15m / +30m / +45m / +60m]}}\vspace{1.5cm}}}
  \caption{Timestamp filter: Step buttons}
\end{figure}

\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: same Step row with one or more buttons disabled in the out-of-bounds state]}}\vspace{1.5cm}}}
  \caption{Timestamp filter: out-of-bounds indication}
\end{figure}
...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: custom filter editor showing an OR condition between two clauses]}}\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: filter context menu open showing the 'Delete Filter' submenu with two custom filters listed]}}\vspace{1.5cm}}}
  \caption{Delete Filter submenu}
\end{figure}
