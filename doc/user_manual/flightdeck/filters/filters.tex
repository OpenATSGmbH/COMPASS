...
Additionally, the value 'null' or 'NULL' can be used to load target reports where no contributing RUs are set. Also, if the respective MLAT data sources have remote unit names defined, the textual names can be used instead (or in combination) with the numerical indexes.
