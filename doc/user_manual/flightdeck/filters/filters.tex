...
\begin{itemize}
  ...
  \item Delete Filter: Can be used to delete custom filters, if present
...
When active, this filter forces loading of MLAT data where the given RUs participated. Depending on whether 'Require Match All' is checked, the following behaviour exists:
