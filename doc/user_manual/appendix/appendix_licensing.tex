...
\section{Appendix: Used Libraries}

While it is permitted to use the AppImage for commercial purposes, \textbf{the used open-source libraries might still prohibit this without further permission}. It is the responsibility of the user to ensure that the license information here is correct and that their use cases are permitted under the referenced licenses.
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | l | l |}
    ...
    osgEarth & GNU LGPL v3 &\href{https://github.com/gwaldron/osgearth/blob/master/LICENSE.txt}{Link} \\ \hline    
