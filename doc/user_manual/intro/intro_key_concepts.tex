...
A \textbf{Data Context} is a named surveillance context grouping the entities that describe the surveillance environment a database was recorded in: data sources, sectors, FFTs, ASTERIX decoding settings and coloring. It is distinct from the program-wide configuration described above. \\\\
