...
The binary will currently only be provided for (somewhat current) Linux 64-bit operating systems. For the following distributions, the AppImage was reported to be working correctly:
...
\includegraphics[width=0.5cm]{../../data/icons/hint.png} Please \textbf{note} that other graphics cards (Intel, Matrox) will in all probability also work, but are not supported. \\\\
