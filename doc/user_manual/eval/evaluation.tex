...
\textbf{Note}: CAT001 and CAT048 cannot be selected as reference data. Reference accuracy filtering requires a maximum X/Y standard deviation, which these categories do not provide. They can still be used as test data. \\
