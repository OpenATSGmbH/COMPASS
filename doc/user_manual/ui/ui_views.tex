...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: the same dataset displayed in Table, Histogram, Scatter, Grid and Geographic View, colored identically according to the active Color Mode]}}\vspace{1.5cm}}}
...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: shared Layers Tree expanded, showing the 'Data' branch (DSType / data source / line / DBContent) and the 'Annotations' branch side by side]}}\vspace{1.5cm}}}
  \caption{Shared Layers Tree}
\end{figure}
