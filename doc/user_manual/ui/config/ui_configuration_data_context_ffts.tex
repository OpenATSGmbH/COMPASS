...
\begin{figure}[H]
  \centering
  \hspace*{-1cm}
    \includegraphics[width=17cm]{figures/data_context_edit_ffts.png}
...
\includegraphics[width=0.5cm]{../../data/icons/hint.png} \textbf{Please note that} at least one of the Mode S Address or the Mode 3/A Code must be set. COMPASS can not identify an FFT that has neither value. The position alone is not sufficient, because aircraft can overfly the FFT position. \\
