...
A given license key can then be added into the text field, either by pasting the license text or dragging \& dropping the license key text file (exactly into the text field):
