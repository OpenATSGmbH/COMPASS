...
\begin{itemize}
\item Sector Layer: Define in which sector layer the new sectors will be grouped
...
one or several smaller sectors can be imported (again into sector layer 'Example') and marked as 'Exclude' sectors and preferably using a different color. \\
