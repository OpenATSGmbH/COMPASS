...
\begin{figure}[H]
  \centering
  \hspace*{-1cm}
    \includegraphics[width=17cm]{figures/data_context_edit_sectors.png}
...
\item Import Air Space...: Imports sectors from a Air Space JSON file
...
\begin{itemize}
\item Rename Layer...: Prompts for a new layer name and assigns it to all sectors of the layer. Renaming to the name of an existing layer merges the two layers
...
When available, the 'Import Air Space...' action opens a dedicated dialog that parses an Air Space JSON file (file format described in \nameref{sec:appendix_airspace}) and shows all contained sectors in a checkable list:

\begin{figure}[H]
  \centering
        \includegraphics[width=12cm]{figures/data_context_edit_airspace.png}
