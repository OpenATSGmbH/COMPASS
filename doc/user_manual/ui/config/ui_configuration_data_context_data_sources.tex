...
\begin{figure}[H]
  \center
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: data source selected in the tree with the Main tab visible on the right]}}\vspace{1.5cm}}}
...
\item SAC/SIC (DS ID): System Area Code, System Identification Code, derived data source ID (255*SAC+SIC)
...
For DSType 'Radar', sensor accuracies can be configured per sensor type:
...
\begin{figure}[H]
  \center
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: MLAT Remote Units tab in the empty state with the 'Add Remote Units' placeholder button]}}\vspace{1.5cm}}}
  \caption{Data Source: MLAT Remote Units empty state}
\end{figure}

\begin{figure}[H]
  \center
    \includegraphics[width=8cm,frame]{figures/configure_mlat_rus.png}
...
\item Indices must be unique and 1-based
\end{itemize}
\ \\
