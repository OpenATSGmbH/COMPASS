...
All FFTs are always stored in the configuration as well as in the database, which means they are persistent and can be used in all new databases. It is useful to define all existing FFTs, since they are immediately used during import of data. \\
