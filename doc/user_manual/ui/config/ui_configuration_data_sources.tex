...
However, for CAT010, CAT020 and CAT062 the option exists to project from a Cartesian X/Y coordinate system to WGS84 latitude and longitudes (when not available in the ASTERIX data). To use this feature during ASTERIX import, set a latitude/longitude for the respective data source.
\\
...
\item For MLAT
\begin{itemize}
\item MLAT Remote Units: Optional RU defintion, for contributing receivers analysis
\end{itemize}
\end{itemize}
\ \\
...
\item Geographic View: Display connection lines for target reports to each contributing receiver
\end{itemize}
\ \\
...
A MLAT RUs definition file shall be defined as follows:
\begin{lstlisting}
1;name1;comment1;4.4157313889;1.5009816667;191.88
2;name2;;4.2488102778;1.2440838889;68.66
3;name3;;4.4709594444;1.6851777778;87.97
\end{lstlisting}
