...
\begin{figure}[H]
  \center
    \hspace*{-0.5cm}
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: 'Show Content' dialog opened from the Configuration menu, showing the flat table with meta variables and DBContent variables, and all columns visible]}}\vspace{1.5cm}}}
