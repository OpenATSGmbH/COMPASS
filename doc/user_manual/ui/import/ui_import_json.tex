...
This task allows importing JSON data from a previous jASTERIX run into the opened database, either from text files or from archives. \\

\begin{figure}[H]
  \centering
  \hspace*{-1.5cm}
    \includegraphics[width=18cm]{figures/import_json_data.png}
...
\begin{figure}[H]
    \centering
    \hspace*{-1.5cm}
    \includegraphics[width=18cm]{figures/import_json_data_object_parser.png}
...
For common users, interaction is normally not recommended, but it might sometimes be interesting to see what database content is created from which JSON data.
