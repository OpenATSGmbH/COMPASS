...
This task allows importing ASTERIX data from a network recording stored as a PCAP file. \\
...
\begin{figure}[H]
    \center
      \hspace*{-0.5cm}
      \includegraphics[width=17cm,frame]{figures/asterix_import_pcap.png}
