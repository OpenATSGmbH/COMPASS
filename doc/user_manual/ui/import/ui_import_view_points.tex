...
This task allows importing view points and respective ASTERIX data recording files into the opened database. \\
...
For the filename in each dataset, the absolute path is searched first. If such a file cannot be found, a file with the same name at the location of the view point file is searched for. 
