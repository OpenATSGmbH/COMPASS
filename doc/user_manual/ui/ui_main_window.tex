...
In the simplest use case, the \nameref{sec:ui_main_menu_bar} allows opening or creating a database and importing data.
...
Flight Deck occupies in the Main Window can be set by hand for the selected tool, as an alternative to pressing 
