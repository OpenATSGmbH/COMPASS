...
\begin{figure}[H]
  \center
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Context menu open with Edit..., Switch submenu, Compare..., New..., Copy... and Delete... entries visible]}}\vspace{1.5cm}}}
...
\begin{figure}[H]
  \center
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: 'Configuration' menu open showing DBContent, Licenses, Dark Mode, Fullscreen and Refresh Views Automatically entries]}}\vspace{1.5cm}}}
...
\begin{itemize}
 ...
 \item Analyze: Submenu providing per-DSType data-source analysis tasks
  \begin{itemize}
   \item MLAT: Analyze one or more MLAT (CAT020 / CAT010) data sources from multiple angles (data items, sensor coverage / PD, position accuracy); see \nameref{chap:analyze}
  \end{itemize}
