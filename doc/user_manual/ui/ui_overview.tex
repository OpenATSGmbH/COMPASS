...
\begin{itemize}
 ...
 \item Refresh Views Automatically: Sets if views should trigger an automatic data reload process if any configuration changes are made (e.g. adding a DBContent variable in Table View)
\end{itemize}
\  \\ 
