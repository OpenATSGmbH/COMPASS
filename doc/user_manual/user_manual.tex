...
\medskip
\medskip
\normalsize\textsf{Version 1.0.0 HotFix4} \\ 
\medskip
\normalsize\textsf{\textit{Defiant Dodo}} \\
\medskip
%\frame{\includegraphics[width=3cm]{release_logo.png}}
\includegraphics[width=6cm,frame]{release_logo.png}
\end{center}
\vspace*{\fill}
\begin{center}
