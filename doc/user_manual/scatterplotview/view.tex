...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Scatter Plot View Configuration Panel with the shared Layers Tree visible]}}\vspace{1.5cm}}}
  \caption{Scatter Plot View: shared Layers Tree in the Config Tab}
\end{figure}
