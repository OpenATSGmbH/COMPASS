...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{ | l | l | X |}
    ...
    Maximum Comparison Time Difference [s] & 6 & Maximum time delta for any code/position comparison \\ \hline 
    Maximum Track Time Difference [s] & 300 & Maximum time delta to a previously associated track \\ \hline
    Maximum Erroneous Distance Air [m] & 9260 & Target/target association \\ \hline
    Maximum Dubious Distance Air [m] & 3704 & Target/target association \\ \hline
    Maximum Acceptable Distance Air [m] & 1852 & Target/target association \\ \hline
...
Please \textbf{note} that a detailed discussion of the given parameters is out of scope for this user manual. For users with a professional license, a dedicated reconstructor user manual appendix will be provided.
