...
\begin{table}[H]
    ...
    Maximum Erroneous Distance Air & Distance limit rejecting position matches (Air). & Intermediate & 5556m (3nm) m & 500 -- 10000 m \\ \hline
    Maximum Dubious Distance Air & Threshold for Dubious classification (Air). & Intermediate & 3704m (2nm) & 250 -- 25000 m \\ \hline
    Maximum Acceptable Distance Air & Threshold for Acceptable classification (Air). Typically 1-2 NM or less. & Intermediate & 1852m (1nm) & 100 -- 10000 m \\ \hline
    Maximum Erroneous Distance Ground & Distance limit rejecting position matches (Ground). & Intermediate & 90m & 70 -- 200m \\ \hline
    Maximum Dubious Distance Ground & Threshold for Dubious classification (Ground). & Intermediate & 60m & 30 -- 100 m \\ \hline
    Maximum Acceptable Distance Ground & Threshold for Acceptable classification (Ground). & Intermediate & 40m & 10 -- 50m \\ \hline
...
\item Association of targets is made for best matches fulfilling a average position difference score
\end{itemize}
