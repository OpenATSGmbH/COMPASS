...
\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Probabilistic + IMM configuration widget with the 'Correct Radar Biases' checkbox highlighted]}}\vspace{1.5cm}}}
  \caption{Reconstructor: Correct Radar Biases toggle}
\end{figure}

\begin{figure}[H]
  \centering
    \fbox{\parbox{0.8\textwidth}{\vspace{1.5cm}\centering \textcolor{red}{\textbf{[FIGURE TODO: Data Context dialog showing the persisted radar bias values for a radar Data Source after a reconstructor run]}}\vspace{1.5cm}}}
  \caption{Data Context: persisted radar bias values}
\end{figure}
...
\textcolor{red}{\textbf{[TODO: confirm whether any user-facing controls were added for the PSR/AC reconstructor improvements; if not, leave this paragraph as-is]}}
