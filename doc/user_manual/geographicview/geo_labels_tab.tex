...
\begin{figure}[H]
  ...
  \caption{Geographic View label: Level of Detail 3}
\end{figure}
...
\begin{itemize}
 ...
 \item Unspecific Aircraft Identifications (for example all zeros, all question marks, or blank, as configured) are skipped in favor of Aircraft Address or Mode 3/A Code, and are only shown if no other identification is available
 \end{itemize}
 \end{itemize} 
\item LoD 2 
 \begin{itemize}
