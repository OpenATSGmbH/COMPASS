...
For each target, a single label is created for the latest shown target report. \\
...
The automatic labeling can be most useful in combination with the time window filter (or in Live mode).
