...
\label{sec:geo_geotiff_import}

External GeoTIFF files can be imported into Geographic View by dragging and dropping them into Geographic View's map view.
...
Interaction with these items is explained in section \nameref{sec:geo_annotation_ops}. \\
...
\begin{figure}[H]
  ...
  \caption{Imported GeoTIFF files listed in Geographic View's Layer tab}
\end{figure}
