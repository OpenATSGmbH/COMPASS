...
\iffalse
 \item Set Color: Open color dialog to set the items color
...
\paragraph{MLAT Remote Units Operations}
If MLAT Remote Unit information is present (see \nameref{sec:ui_configure_ds_mlat_rus}), the following operations exist:

\begin{itemize}
 \item Show MLAT Contributing RUs: Shows connection lines between target reports and the contributing MLAT Remote Units.
 \item Clear MLAT Contributing RUs: Clear connection lines between target reports and the contributing MLAT Remote Units.
\end{itemize}

\paragraph{Special Root Geometry Layer Operations}
This layer has special operations present:

\begin{itemize}
 \item Reset All Styles: Sets all style information to default (including make all data visible)
 \item Clear All Associations: Removes display of all shown associations of all data
\end{itemize}
