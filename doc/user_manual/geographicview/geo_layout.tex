...
\begin{itemize}
 ...
 \item Data Widget (lower left): Displays map and data
 \item Configuration panel (right): Allows adaptation of what and how data is displayed
\end{itemize}
\ \\
...
How the data is presented is defined in the Configuration panel, please refer to \nameref{sec:geoview_config_panel} for details. \\
...
\begin{itemize}
 \item 2D: Displays map in a 2D projection and (per default) disables usage of height in data drawing
 \item 3D: Displays map as a globe and (per default) enables usage of height in data drawing
\end{itemize}
\ \\
