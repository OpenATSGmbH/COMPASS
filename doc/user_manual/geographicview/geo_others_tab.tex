...
\begin{itemize}
 \item Show MLAT Contributing RUs: Defines if MLAT Contributing RUs should be shown automatically for all MLAT data.
\end{itemize}

For specific target reports position MLAT Contributing RUs can be shown using \nameref{sec:geometry_operations}:
...
The slider changes the line opacity for the following items:
\begin{itemize}
